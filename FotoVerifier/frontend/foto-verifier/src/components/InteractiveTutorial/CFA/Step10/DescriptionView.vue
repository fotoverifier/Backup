<template>
  <h5 class="title">10. Use "Color Filter Array Detection" tool</h5>
  <p v-if="step == 1">
    ...
    <strong style="color: rgb(97, 189, 109)">uploaded image</strong>, called
    <strong style="color: #f27289">Color Filter Array Detection</strong>. Now we
    will guide you step by step to open this tool.
  </p>

  <p v-if="step == 3">
    Now you can see the <strong style="color: #f27289">result</strong> in the
    <strong style="color: #f27289">image on the right</strong>, the image area
    <strong style="color: rgb(97, 189, 109)">pasted</strong> into the
    <strong style="color: rgb(97, 189, 109)">original image</strong> has been
    <strong style="color: rgb(97, 189, 109)">extracted</strong> by the tool. You
    can see more clearly by moving the mouse over an area and the area will be
    enlarged.
  </p>
</template>
