<template>
  ...
  <p>
    ...
    with uploading photos, we've included a sample photo below. Please
  ...
  <div class="sample-image" :class="{ shake: isShake }">
    <img src="/image/interactive-tutorial/cfa/sample.png" class="img-fluid" />
    <center>
      <p><strong style="color: #f27289">sample.png</strong></p>
    </center>
  </div>
</template>
