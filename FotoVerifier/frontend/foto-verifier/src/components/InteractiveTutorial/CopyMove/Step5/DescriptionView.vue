<template>
  <h5 class="title">5. Check Image Cloning with FotoVerifier</h5>
  <p>
    By this step we believe that you have understood the concept of
    <strong style="color: #f27289">Image Cloning</strong>. Therefore we will
    show you <strong style="color: rgb(44, 130, 201)">how to detect</strong> an
    image that has been edited with Image Cloning using our
    <strong style="color: rgb(44, 130, 201)">FotoVerifier tool</strong>. This
    tool can show
    <strong style="color: rgb(97, 189, 109)">copied areas</strong> in an image
    even if they have been edited after pasting, such as
    <strong style="color: rgb(250, 197, 28)">rotation</strong> or
    <strong style="color: rgb(250, 197, 28)">resizing</strong> or
    <strong style="color: rgb(250, 197, 28)">change color</strong>. Now follow
    our steps to understand how to use the tool.
  </p>
  <p>
