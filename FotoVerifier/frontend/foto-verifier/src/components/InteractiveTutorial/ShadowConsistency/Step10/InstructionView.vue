<template>
  <div class="row">
    <div class="col-md-12 pt-2">
      <p v-if="step == 1">
        Click on
        <strong style="color: #f27289">Check shadow consistency</strong> on the
      ...
      <p v-if="step == 4">
        ...
        <strong style="color: rgb(97, 189, 109)"
          >Attached Shadow Constraint</strong
        >
        section in the
      ...
      <p v-if="step == 5">
        ...
        <strong style="color: rgb(250, 197, 28)">attached shadow</strong> of the
        <strong style="color: #f27289">silver car</strong> by clicking at
        <strong style="color: rgb(250, 197, 28)">blinking yellow circle</strong>
        in <strong style="color: rgb(97, 189, 109)">image view</strong>.
      </p>

      <p v-if="step == 6">
        Select a point <strong style="color: rgb(250, 197, 28)">B</strong> such
        that <strong style="color: rgb(250, 197, 28)">vector AB</strong> points
        towards the
        <strong style="color: rgb(250, 197, 28)">light source</strong> by
        clicking at
        <strong style="color: rgb(250, 197, 28)">blinking yellow circle</strong>
        in <strong style="color: rgb(97, 189, 109)">image view</strong>.
      </p>
      ...
      <p v-if="step == 16">
        Click on
        <strong style="color: rgb(97, 189, 109)">
          Check Shadow Consistency</strong
        >
        button in the
