<template>
  <h5 class="title">8. Check Shadow Consistency with FotoVerifier</h5>
  <p>
    By this point we believe you have understood the idea of using called
    <strong style="color: #f27289">Shadow Consistency</strong> to detect
    <strong style="color: rgb(97, 189, 109)">forgery</strong>
    in an image. However, checking whether
    <strong style="color: #f27289">wedge regions</strong> intersect or not is
    sometimes hard to the naked eye. Therefore, we introduce to you the
    <strong style="color: #f27289">Check Shadow Consistency</strong> tool on our
    <strong style="color: rgb(44, 130, 201)">FotoVerifier</strong> site and how
    to use it to detect images that have been edited with
    <strong style="color: #f27289">Shadow Consistency</strong>.
  </p>
  <p>
    In this tool, you need to draw
    <strong style="color: #f27289">wedge regions</strong> for the
    <strong style="color: rgb(250, 197, 28)">shadows</strong> on the image,
    called <strong style="color: rgb(250, 197, 28)">Shadow Constraints</strong>.
    ...
    are <strong style="color: #f27289">inconsistent</strong>. From there you can
    deduce the area of the image that has been edited.
  </p>
  <p>
    Now let's see how to access the
    <strong style="color: rgb(44, 130, 201)">Check Shadow Consistency</strong>
