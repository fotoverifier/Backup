<template>
  <h5 class="title">9. Upload Image</h5>
  <p>
    Then you need to
    ...
    there are <strong style="color: #f27289">two female dancers</strong> who
    look very <strong style="color: #f27289">similar</strong>, most likely this
    photo has been edited using
    <strong style="color: #f27289">Image Cloning</strong> method. Please
  ...
  <div class="sample-image" :class="{ shake: isShake }">
    <img
      src="/image/interactive-tutorial/shadow-consistency/sample.jpg"
      class="img-fluid"
    />
    <center>
