<template>
  ...
  />
  <p v-if="isFinished">
    <strong style="color: #090c91">Blue block: </strong> Edited Region
  </p>
  <p v-if="isFinished">
    <strong style="color: #068305">Green block: </strong> Original Region
  </p>
</template>
  ...
  setup(props) {
    ...
    let jpegGhost = function () {
      ...
      sourceImg.onload = async function () {
        ...
        fetch("/api/jpeg-ghost", requestOptions)
