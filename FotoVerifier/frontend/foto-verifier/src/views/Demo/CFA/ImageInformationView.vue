      ...
      <div class="row my-container image-information-content">
        <div class="col-sm-6 p-2">
          ...
          <div class="container">
            ...
            <div class="metadata">
              <div class="row">
                <div class="col-sm-6"><b>ImageWidth</b></div>
                <div class="col-sm-6">648</div>
              </div>
              <div class="row">
                <div class="col-sm-6"><b>ImageHeight</b></div>
                <div class="col-sm-6">648</div>
              </div>
              <div class="row">
                <div class="col-sm-6"><b>BitDepth</b></div>
                <div class="col-sm-6">8</div>
              </div>
              <div class="row">
                <div class="col-sm-6"><b>ColorType</b></div>
                <div class="col-sm-6">RGB with Alpha</div>
              </div>
              <div class="row">
                <div class="col-sm-6"><b>Compression</b></div>
                <div class="col-sm-6">Deflate/Inflate</div>
              </div>
              <div class="row">
                <div class="col-sm-6"><b>Filter</b></div>
                <div class="col-sm-6">Adaptive</div>
              </div>
              <div class="row">
                <div class="col-sm-6"><b>Interlace</b></div>
                <div class="col-sm-6">Noninterlaced</div>
              </div>
            </div>
          </div>
        </div>
  ...
  setup() {
    ...
    let iframeEvent = function (event) {
      if (typeof event.data !== "undefined" && event.data !== null) {
        ...
        } else if (event.data == "step-10-show-hint-2") {
          isShowHint2.value = true;
        } else if (event.data == "step-10-show-hint-3") {
    ...
    let img = new Image();
    img.src = "/image/interactive-tutorial/cfa/sample.png";
    ...
    let hideHint2 = function () {
      ...
      window.parent.postMessage("step-10-hide-hint-2", window.location.origin);
    };

    let hideHint3 = function () {
      isShowHint3.value = false;
      window.parent.postMessage("step-10-hide-hint-3", window.location.origin);
    };
    ...
    let moveToStep3 = function () {
      step.value = 3;
      let img = new Image();
      img.src = "/image/interactive-tutorial/cfa/result.png";
