      ...
      <div class="row my-container image-information-content">
        <div class="col-sm-6 p-2">
          ...
          <div class="container">
            ...
            <div class="metadata">
              <div class="row">
                <div class="col-sm-6"><b>Orientation</b></div>
                <div class="col-sm-6">Horizontal (normal)</div>
              </div>
              <div class="row">
                <div class="col-sm-6"><b>XResolution</b></div>
                <div class="col-sm-6">72</div>
              </div>
              <div class="row">
                <div class="col-sm-6"><b>YResolution</b></div>
                <div class="col-sm-6">72</div>
              </div>
              <div class="row">
                <div class="col-sm-6"><b>ResolutionUnit</b></div>
                <div class="col-sm-6">inches</div>
              </div>
              <div class="row">
                <div class="col-sm-6"><b>Software</b></div>
                <div class="col-sm-6">Adobe Photoshop CC 2015 (Windows)</div>
              </div>
              <div class="row">
                <div class="col-sm-6"><b>ModifyDate</b></div>
                <div class="col-sm-6">
                  Fri Jun 17 2022 14:07:17 GMT+0700 (Giờ Đông Dương)
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6"><b>ColorSpace</b></div>
                <div class="col-sm-6">65535</div>
              </div>
              <div class="row">
                <div class="col-sm-6"><b>ExifImageWidth</b></div>
                <div class="col-sm-6">1000</div>
              </div>
              <div class="row">
                <div class="col-sm-6"><b>ExifImageHeight</b></div>
                <div class="col-sm-6">750</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6">
          <div class="d-flex flex-row">
            <div class="pt-2">
              <h4>
                <b>
                  <p class="content-title">Copy-Move Detection</p>
                </b>
              </h4>
            </div>
          </div>
  ...
  setup() {
    ...
    let iframeEvent = function (event) {
      if (typeof event.data !== "undefined" && event.data !== null) {
        ...
        } else if (event.data == "step-7-show-hint-2") {
          isShowHint2.value = true;
        } else if (event.data == "step-7-show-hint-3") {
    ...
    let img = new Image();
    img.src = "/image/interactive-tutorial/copy-move/sample.jpg";
    ...
    let hideHint2 = function () {
      ...
      window.parent.postMessage("step-7-hide-hint-2", window.location.origin);
    };

    let hideHint3 = function () {
      isShowHint3.value = false;
      window.parent.postMessage("step-7-hide-hint-3", window.location.origin);
    };
    ...
    let moveToStep3 = function () {
      step.value = 3;
      let img = new Image();
      img.src = "/image/interactive-tutorial/copy-move/result.png";
